...
% performance of two ways of estimating the variance of an isotropic Matern
% process, as a function of its parameters (variance, differentiability,
% range) and for a suite of field sizes. The 'poor' way is simply the sample
% variance, whereas the 'mle' way refers to the maximum-likelihood
% estimation procedure. The data plotted in this figure are generated by
% invoking SIMULOSL('demo4'). There's also a shortcut to plot other
% Matern parameters in the right-hand-side panels, but that's better in EGGERS7.
%
% INPUT:
%
